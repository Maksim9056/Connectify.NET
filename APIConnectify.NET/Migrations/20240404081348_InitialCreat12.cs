        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    FriendIdId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroupsChats_Files_FilesId",
                        column: x => x.FilesId,
                        principalTable: "Files",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupUsers_Users_ParticipantsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupsChats_FilesId",
                table: "GroupsChats",
                column: "FilesId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupsChats_GroupId",
                table: "GroupsChats",
                column: "GroupId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupUsers_ParticipantsId",
                table: "GroupUsers",
